// This compoent displays recipe detail
    ...
    return ( <>
        ...
        {recipeDetail==undefined?"":<>
           ...
           {isCurrentInPlanner?
            ...
            <div className="info">{icons[recipeDetail.type]} {recipeDetail.type}<br/>Cooking Time: {recipeDetail.cookingTimeInMinute} min</div>
